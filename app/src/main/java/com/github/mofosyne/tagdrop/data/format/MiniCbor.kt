 ...
 *   - Null (0xf6)
 *
 * Values over 2^32 are not supported. This keeps the implementation ~80 lines
...
object MiniCbor {
     ...
     * which is how optional fields (hint, filename) are handled.
     */
    ...
    /** Returns a Map<Int, Any> where Any is Long, ByteArray, or String. */
